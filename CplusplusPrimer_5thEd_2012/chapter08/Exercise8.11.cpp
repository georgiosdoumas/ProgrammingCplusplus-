...
// read the input a line at a time until cin hits end-of-file (or another error)
   if(argc==1) // only the executable was given as a command
   {
   ...
   else if (argc == 2 )  // along with the executable, 1 argument was provided: the name of a file
   {
	 ...
	 cout << "Specify inputfile as a command-line argument, only 1 arg should be given"<< endl; 
	 return -1;
    }
