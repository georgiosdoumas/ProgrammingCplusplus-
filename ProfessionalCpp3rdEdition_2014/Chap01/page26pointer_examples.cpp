...
#include <iostream>
using namespace std;
// uncomment the several variations of main and compile-run each program one by one , and think on the results
/*
int main()
{
...
int main()
{
    ...
    // next line produces a segm-fault immediately when the program is run, because the *myIntegerPointer means the contents of a memory not-yet allocated
    ...
    cout << myIntegerPointer << " memory location is on the heap, with contents(before assigning): " << *myIntegerPointer << endl;
    *myIntegerPointer = 27;
    cout << myIntegerPointer << " memory location is on the heap, with contents(after assigning): " << *myIntegerPointer << endl;
    ...
    //cout << myIntegerPointer << " memory location has been set o nullptr, contents are "<< *myIntegerPointer << endl; //Gives segm-fault on execution
...
int main()
{
    ...
    *pointer2double = 37.6 ; 
    ...
    cout << " we did a delete, and now we will reassign " << endl;
    *pointer2double = 42.3;  // the pointer is still alive! I do not know what the delete really does! 
    cout << pointer2double << " memory location, is still on the heap, with new content: " << *pointer2double << endl;
    //double* pointer2double = new double; // compiler error, complains about previoulsy declared 
    pointer2double = new double;   
    cout << "After new ... " << endl;
    cout << pointer2double << " memory location, persists on the heap, with the same contents: " << *pointer2double << endl;
    pointer2double = nullptr; 
...
int main()
{
    ...
    cout << &double_on_the_stack << " memory location is on the stack, with contents: "<< double_on_the_stack << endl;
    double* pointer2double = new double ;
    ...
    *pointer2double = 23.9;
    ...
    cout << pointer2double << " memory location is(?) on the heap, with contents: " << *pointer2double << endl;
    //delete pointer2double ; // now there is no point to delete , and actually this line gives an execution error-  munmap_chunk(): invalid pointer
    return 0;
}
//*/
